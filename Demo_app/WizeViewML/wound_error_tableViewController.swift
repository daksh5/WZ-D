//
//  wound_error_tableViewController.swift
//  Demo_app
//
...
class wound_error_tableViewController: UIViewController, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "e_w_cell")! as! wound_errorTableViewCell
