...
class MedicineViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    {
        if segue.destination is saving_medicineViewController
        {
            let vc = segue.destination as? saving_medicineViewController
